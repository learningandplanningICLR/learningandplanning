...
from embedding_dqn.abstraction_tools.abstraction_interfaces import AbstractState
...
if __name__ == "__main__":
    map_file = 'mr_maps/full_mr_map.txt'  # 'mr_maps/four_rooms.txt' # 'mr_maps/full_mr_map.txt'
